...
# ThinFilm.py: Thin film interference by reflection
...
nA = arange(0,1250,10)       
delR =  2*pi*nA/lamR+pi; delG = 2*pi*nA/lamG+ pi
delB =  2*pi*nA/lamB+pi 
intR = (cos(delR/2))**2; intG = (cos(delG/2))**2
intB = (cos(delB/2))**2 
xrp =  300*intR-150; xbp =  300*intB-150;  xgp =  300*intG-150  
