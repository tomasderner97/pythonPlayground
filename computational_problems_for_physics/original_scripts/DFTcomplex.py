...
SignalGraph = graph(x=0, y=0, width=600, height=250, title ='Signal y(t)',
    xtitle='x',ytitle='y(t)', xmax=2.*math.pi, xmin=0, ymax=250, ymin=-250)
SignalCurve = gcurve(color=color.red)
TransformGraph = graph(x=0,y=250,width=600,height=250,title ='Im Y(omega)',
