...
ps = zeros((max),float)
step = 2*math.pi/1000
graph1 = graph(x=0,y=0,width=600,height=250,title='Pure Signal', \
	xtitle='t (s)',ytitle='f(t)',xmin=0,xmax=25,ymin=0,ymax=10)
funct1 = gcurve(color=color.red)
graph2 = graph(x=0,y=250,width=600,height=250, title='Signal+Noise',\
         xtitle='t (s)',ytitle='y(t)',xmin=0,xmax=25,ymin=0,ymax=10)
funct2 = gcurve(color=color.red)
graph3 = graph(x=0,y=500,width=600,height=250, title='Filtered Input',\
         xtitle='t (s)',ytitle='y(t)',xmin=0,xmax=25,ymin=0,ymax=10)
