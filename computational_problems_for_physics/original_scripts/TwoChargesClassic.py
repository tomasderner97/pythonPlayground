...
scene = display(width=700,height=300, ange=1, background=(1,1,1),
           title="O: Charges with Parallel Initial Velocities")
...
scene2 = display(y=700,width=700,height=300, range=1, 
	background=(1,1,1),title= "O': Motion in Moving Frame")
r1p = r1;    r2p = r2
...
def EulerPlusTF(u, r1, r2, beta):  # Euler ODE + Lorentz TF
    v2 = u;    v1 = u                                         
