...
SignalGraph = gdisplay(x=0, y=0, width=600, height=250, 
	title ='Signal y(t)', xtitle='x',ytitle='y(t)', 
	xmax=2.*math.pi, xmin=0, ymax=30, ymin=-30)
SignalCurve = gcurve(color=color.yellow, display=SignalGraph)
TransformGraph = gdisplay(x=0,y=250,width=600,height=250,
	title ='Im Y(omega)',xtitle = 'x',ytitle='Im Y(omega)',
	xmax=10.,xmin=-1,ymax=100,ymin=-250)
